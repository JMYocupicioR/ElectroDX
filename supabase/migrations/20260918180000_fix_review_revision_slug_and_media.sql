-- ==============================================================================
-- Migration: 20260918180000_fix_review_revision_slug_and_media.sql
-- Description: Fix review_revision RPC in Supabase:
--   1. Ensure slug is never null (fallback to target_topic_id or p->>'id').
--   2. Properly build media jsonb from youtubeUrls, videoUrls, etc.
--   3. Ensure proper permissions and search_path.
-- ==============================================================================
...
BEGIN
  ...
  IF new_status = 'approved' THEN
    ...
    ELSE
      ...
      ELSE
        -- Unificar estructura de media (puede venir como p->'media' o como propiedades sueltas)
        v_media := CASE 
