...
import { BookOpen, Home, Sun, Moon, Globe, Menu, Users, LogIn, Scale } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 h-14 sm:h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link to="/" className="flex items-center gap-2 sm:gap-3 group">
              ...
              <div className="hidden sm:block">
                <span className="font-bold text-slate-800 dark:text-white text-lg tracking-tight">Curso ENMG</span>
                <span className="text-slate-400 dark:text-slate-500 text-sm ml-1.5 font-light">DLM</span>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            {isSupabaseConfigured && user ? (
              ...
              <Link
                to="/auth/login"
                className="flex items-center gap-1.5 px-2.5 py-2 rounded-lg text-sm text-slate-500 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all"
              >
