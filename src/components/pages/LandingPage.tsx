...
import {
  ...
  Check, Sparkles, BarChart3, Award, Users, ClipboardCheck, ArrowRight, Lock, Unlock, Video
} from 'lucide-react';
        ...
        <section className="px-4 pb-16 md:pb-24">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              className="text-center mb-10"
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500/10 text-red-700 dark:text-red-300 text-sm font-medium mb-4 border border-red-500/20">
                <Video className="w-3.5 h-3.5" />
                Eventos en Vivo
              </div>
              <h2 className="text-2xl md:text-3xl font-bold mb-3">
                <span className="bg-gradient-to-r from-red-600 to-orange-600 dark:from-red-400 dark:to-orange-400 bg-clip-text text-transparent">Talleres Clínicos</span>
              </h2>
              <p className="text-slate-500 dark:text-slate-400">Análisis de casos reales con especialistas (Premium)</p>
            </motion.div>
            ...
            >
              {upcomingWorkshops.map((ws) => (
                <motion.div key={ws.id} variants={cardVariants}>
