// CaseTemplatesExpanded4.ts — Batch 4: Tarsal Tunnel, C7 Radiculopathy, Accessory Peroneal Anomaly (Pitfall)
...
export const EXPANDED_TEMPLATES_4: CaseTemplate[] = [
  // ═══════════ 31. SÍNDROME DEL TÚNEL DEL TARSO ═══════════
  {
    ...
    ncs: [
      { nerve: 'Tibial (plantar medial)', type: 'motor', latency: [5.5, 8.0], amplitude: [1.5, 5], velocity: [35, 45], normalRanges: { latency: [3.0, 4.5] as [number,number], amplitude: [5, 15] as [number,number], velocity: [41, 55] as [number,number] } },
      { nerve: 'Tibial (plantar lateral)', type: 'motor', latency: [5.5, 8.0], amplitude: [1, 4], velocity: [35, 45], normalRanges: { latency: [3.0, 5.0] as [number,number], amplitude: [4, 12] as [number,number], velocity: [41, 55] as [number,number] } },
      ...
      { nerve: 'Plantar medial mixto', type: 'sensory', latency: [4.0, 6.0], amplitude: [0.5, 3], velocity: [30, 42], normalRanges: { latency: [2.0, 3.5] as [number,number], amplitude: [3, 12] as [number,number], velocity: [40, 55] as [number,number] } },
    ],
    emg: [
  ...
  // ═══════════ 32. RADICULOPATÍA C7 ═══════════
  {
    ...
    ncs: [
      { nerve: 'Mediano', type: 'motor', latency: [2.8, 3.8], amplitude: [5, 11], velocity: [50, 62], normalRanges: { latency: [2.5, 4.2] as [number,number], amplitude: [4, 12] as [number,number], velocity: [49, 65] as [number,number] } },
      { nerve: 'Cubital', type: 'motor', latency: [2.2, 3.2], amplitude: [7, 13], velocity: [50, 62], normalRanges: { latency: [2.0, 3.5] as [number,number], amplitude: [6, 14] as [number,number], velocity: [49, 65] as [number,number] } },
      { nerve: 'Mediano', type: 'sensory', latency: [2.2, 3.2], amplitude: [18, 42], velocity: [52, 62], normalRanges: { latency: [2.0, 3.5] as [number,number], amplitude: [15, 50] as [number,number], velocity: [50, 65] as [number,number] } },
      { nerve: 'Radial', type: 'sensory', latency: [1.8, 2.8], amplitude: [16, 38], velocity: [52, 60], normalRanges: { latency: [1.5, 2.9] as [number,number], amplitude: [15, 40] as [number,number], velocity: [50, 65] as [number,number] } },
    ],
    emg: [
  ...
  // ═══════════ 33. NERVIO PERONEO ACCESORIO (VARIANTE ANATÓMICA) — TRAMPA ═══════════
  {
    ...
    ncs: [
      ...
      { nerve: 'Peroneo superficial', type: 'sensory', latency: [2.5, 3.5], amplitude: [8, 22], velocity: [42, 52], normalRanges: { latency: [2.5, 3.8] as [number,number], amplitude: [5, 20] as [number,number], velocity: [40, 55] as [number,number] } },
    ],
    emg: [
