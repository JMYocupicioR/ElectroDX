...
export const nerveDatabase: NerveData[] = [
  ...
  // Upper Extremity - Sensory
  {
    ...
    referenceValues: {
      latency: { min: 2.0, max: 3.5 },
      amplitude: { min: 15, max: 50 },
      velocity: { min: 50, max: 70 }
    }
  },
  {
  ...
  },
  {
    ...
    referenceValues: {
      latency: { min: 2.0, max: 3.2 },
      amplitude: { min: 10, max: 40 },
      velocity: { min: 50, max: 70 }
    }
  },
  {
    id: 'radial_sensory',
    name: 'Nervio Radial - Sensitivo (Dorso mano-Antebrazo)',
    referenceValues: {
      latency: { min: 2.0, max: 3.5 },
      amplitude: { min: 8, max: 30 },
      velocity: { min: 45, max: 65 }
    }
  },
  ...
  },
  {
    ...
    referenceValues: {
      latency: { min: 2.5, max: 4.5 },
      amplitude: { min: 3.0, max: 20.0 },
      velocity: { min: 45, max: 60 }
    }
  },

  // Legacy entries for backward compatibility (keeping original names)
  {
    id: 'peroneal',
    name: 'Peroneo',
    referenceValues: {
