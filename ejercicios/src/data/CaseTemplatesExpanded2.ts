// CaseTemplatesExpanded2.ts — Batch 2: STC Severo, Radiculopatías L5/S1, MMN, y 3 Casos Trampa
...
export const EXPANDED_TEMPLATES_2: CaseTemplate[] = [
  // ═══════════ 17. STC SEVERO ═══════════
  {
  ...
  // ═══════════ 18. RADICULOPATÍA L5 ═══════════
  {
    ...
    ncs: [
      ...
      { nerve: 'Peroneo superficial', type: 'sensory', latency: [2.8, 3.8], amplitude: [8, 22], velocity: [42, 52], normalRanges: { latency: [2.5, 3.8] as [number,number], amplitude: [5, 20] as [number,number], velocity: [40, 55] as [number,number] } },
