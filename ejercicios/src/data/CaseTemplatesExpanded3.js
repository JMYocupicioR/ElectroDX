const NR = {
    ...
    radialMotor: { latency: [2.0, 3.5], amplitude: [3, 10], velocity: [50, 65] },
};
export const EXPANDED_TEMPLATES_3 = [
    // ═══════════ 24. POLINEUROPATÍA DIABÉTICA ═══════════
    {
        ...
        ncs: [
            ...
            { nerve: 'Peroneo superficial', type: 'sensory', latency: [3.5, 5.0], amplitude: [1, 6], velocity: [32, 44], normalRanges: { latency: [2.5, 3.8], amplitude: [5, 20], velocity: [40, 55] } },
