// CaseTemplatesExpanded.ts — 15 nuevos templates clínicos
// Plexopatías, NMJ, GBS, CIDP, más atrapamientos, radiculopatías, MMN, y casos trampa
...
const NR = {
  ...
  musculocutSensory: { latency: [2.0, 3.0] as [number,number], amplitude: [8, 30] as [number,number], velocity: [50, 65] as [number,number] },
};

export const EXPANDED_TEMPLATES: CaseTemplate[] = [
  // ═══════════ 9. PLEXOPATÍA BRAQUIAL SUPERIOR (Erb-Duchenne) ═══════════
  {
    ...
    ncs: [
      { nerve: 'Musculocutáneo', type: 'motor', latency: [3.5, 5.0], amplitude: [0.5, 2.0], velocity: [40, 50], normalRanges: { latency: [2.5, 4.0] as [number,number], amplitude: [3, 10] as [number,number], velocity: [50, 65] as [number,number] } },
      { nerve: 'Axilar', type: 'motor', latency: [3.0, 4.5], amplitude: [0.3, 1.5], velocity: [38, 48], normalRanges: { latency: [2.0, 3.5] as [number,number], amplitude: [3, 12] as [number,number], velocity: [50, 65] as [number,number] } },
  ...
  // ═══════════ 10. PLEXOPATÍA BRAQUIAL INFERIOR (Klumpke) ═══════════
  {
    ...
    ncs: [
      ...
      { nerve: 'Antebraquial cutáneo medial', type: 'sensory', latency: [2.5, 3.5], amplitude: [1, 5], velocity: [42, 52], normalRanges: { latency: [2.0, 3.0] as [number,number], amplitude: [8, 25] as [number,number], velocity: [50, 65] as [number,number] } },
    ],
    emg: [
  ...
  // ═══════════ 11. MIASTENIA GRAVIS ═══════════
  {
    ...
    ncs: [
      { nerve: 'Mediano', type: 'motor', latency: [2.8, 3.8], amplitude: [5, 11], velocity: [50, 60], normalRanges: NR.medianMotor },
      { nerve: 'Cubital', type: 'motor', latency: [2.2, 3.2], amplitude: [7, 13], velocity: [50, 62], normalRanges: NR.ulnarMotor },
      { nerve: 'Accesorio espinal', type: 'motor', latency: [2.0, 3.5], amplitude: [4, 10], velocity: [48, 58], normalRanges: { latency: [1.5, 3.5] as [number,number], amplitude: [5, 15] as [number,number], velocity: [45, 60] as [number,number] } },
  ...
  // ═══════════ 16. NEUROPATÍA PERONEAL EN CABEZA DE PERONÉ ═══════════
  {
    ...
    ncs: [
      ...
      { nerve: 'Peroneo superficial', type: 'sensory', latency: [3.0, 4.5], amplitude: [2, 8], velocity: [35, 48], normalRanges: { latency: [2.5, 3.8] as [number,number], amplitude: [5, 20] as [number,number], velocity: [40, 55] as [number,number] } },
